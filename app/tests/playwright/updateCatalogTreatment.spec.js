  ...
  for (let i = 0; i < rowCount; i++) {
    ...
    if (rowText.includes('John Doe')) {
      ...
      // Form elemanlarını doldur
        // treatment name
    await page.waitForSelector('#id_treatment_name', { visible: true, timeout: 5000 });
    await page.fill('#id_treatment_name', 'John Doe');
    ...
    await page.click('.select2-results__option:has-text("John Doe")'); // Seç
      ...
      //treatment  description
        ...
        await page.fill('#id_description', 'John Doe catalog treatment description');
